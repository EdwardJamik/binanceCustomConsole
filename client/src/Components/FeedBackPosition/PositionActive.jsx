                    ...
                    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                        {record.positionData.positionSide === 'LONG' &&
                            (() => {
                                ...
                                const fixProfit = record?.ordersId?.withoutLoss ? (((parseFloat(record?.ordersId?.withoutLoss?.fixedPrice) - parseFloat(record?.startPrice)) * parseFloat(record?.positionData?.origQty)) - ((parseFloat(record?.positionData?.origQty) * parseFloat(record?.ordersId?.withoutLoss?.fixedPrice) * parseFloat(record?.openedConfig?.commission)) + parseFloat(record?.commission))).toFixed(2) : record?.ordersId?.TAKE_PROFIT_MARKET ? ((((parseFloat(record?.ordersId?.TAKE_PROFIT_MARKET?.stopPrice) - parseFloat(record?.startPrice)) * ((parseFloat(record?.openedConfig?.quantity)))))).toFixed(2) : 0
                        ...
                        {record.positionData.positionSide === 'SHORT' &&
                            (() => {
                                ...
                                const fixProfit = record?.ordersId?.withoutLoss ? (((parseFloat(record?.startPrice) - parseFloat(record?.ordersId?.withoutLoss?.fixedPrice)) * parseFloat(record?.positionData?.origQty)) - ((parseFloat(record?.positionData?.origQty) * parseFloat(record?.ordersId?.withoutLoss?.fixedPrice) * parseFloat(record?.openedConfig?.commission)) + parseFloat(record?.commission))).toFixed(2) : record?.ordersId?.TAKE_PROFIT_MARKET ? ((((parseFloat(record?.startPrice) - parseFloat(record?.ordersId?.TAKE_PROFIT_MARKET?.stopPrice)) * ((parseFloat(record?.openedConfig?.quantity)))))).toFixed(2) : 0
